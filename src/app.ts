...
// ── the command tree ─────────────────────────────────────────────────────────
//
// Building the CLI is kept apart from running it so a test can hold an instance
// and drive commands through `cli.execute` in process, rather than paying for a
// spawned binary per assertion.
